...
#include <jni.h>
#include "../../VirtualApkPatch/patch/virtual_apk_patch.h"
#ifdef __cplusplus
extern "C" {
#endif

    JNIEXPORT int
    Java_com_github_sisong_HotUnity_virtualApkPatch(JNIEnv* jenv,jobject jobj,
    ...
    JNIEXPORT int
    Java_com_github_sisong_HotUnity_virtualApkMerge(JNIEnv* jenv,jobject jobj,
                                                    jstring baseApk,jstring baseSoDir,
                                                    jstring hotApk,jstring hotSoDir,
